...
from dioptra.restapi.v1.entrypoints.schema import EntrypointConfigResponseSchema
...
class JobSwapSchema(Schema):
    ...
    taskName = fields.String(
        ...
        data_key="taskName",
        allow_none=True,
        metadata={"description": "Name of the selected task."},
        dump_only=True,
    )
...
class JobConfigSchema(EntrypointConfigResponseSchema):
