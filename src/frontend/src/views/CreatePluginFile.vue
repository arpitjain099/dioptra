<template>
  <div class="row items-center justify-between">
    <PageTitle :title="title" resourceType="file" :deleted="pluginFile.deleted" />
    <q-btn 
  ...
  <q-banner v-if="pluginFile.deleted" dense class="text-white bg-red q-mt-md">
    <template #avatar>
    ...
    <fieldset :class="`${isMobile ? 'col-12' : 'col q-ml-md'}`">
      ...
      >
        ...
        <div style="font-size: 18px;">
          {{ props.row.name }}
          <q-btn :disable="pluginFile.deleted" icon="edit" round size="sm" color="primary" flat />
        </div>
          <q-popup-edit v-model="props.row.name" v-slot="scope" :disable="pluginFile.deleted">
        ...
        <template #body-cell-inputParams="props">
          <div v-for="(param, i) in props.row.inputParams" :key="i">
            <q-chip
              ...
              @click="!pluginFile.deleted && (handleSelectedParam('edit', props, i, 'inputParams', 'functions'), showEditParamDialog = true)"
            >
              {{ `${param.name}` }}
        ...
        <template #body-cell-outputParams="props">
          <div v-for="(param, i) in props.row.outputParams" :key="i">
            <q-chip
              ...
              :clickable="!pluginFile.deleted"
              :removable="!pluginFile.deleted"
              @click="!pluginFile.deleted && (handleSelectedParam('edit', props, i, 'outputParams', 'functions'), showEditParamDialog = true)"
        ...
        <template #body-cell-outputParams="props">
          <div v-for="(param, i) in props.row.outputParams" :key="i">
            <q-chip
              ...
              :clickable="!pluginFile.deleted"
              :removable="!pluginFile.deleted"
              @click="!pluginFile.deleted && (handleSelectedParam('edit', props, i, 'outputParams', 'artifacts'), showEditParamDialog = true)"
